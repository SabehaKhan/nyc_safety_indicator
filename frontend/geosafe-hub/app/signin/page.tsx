      ...
      <main className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold text-gray-900">Sign in to GeoSafe Hub</h2>
            <p className="mt-2 text-sm text-gray-600">Access your safety profiles and saved locations</p>
          </div>
