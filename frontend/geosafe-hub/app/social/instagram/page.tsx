    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto px-4">
          <div className="mb-6 flex justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" className="mb-4">
              <linearGradient id="instagram-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
                ...
                <stop offset="125%" stopColor="#E1306C" />
                <stop offset="150%" stopColor="#C13584" />
                <stop offset="175%" stopColor="#833AB4" />
                <stop offset="200%" stopColor="#5851DB" />
                <stop offset="225%" stopColor="#405DE6" />
              </linearGradient>
              <path
          ...
          <h1 className="text-4xl font-bold mb-6">Follow GeoSafe Hub on Instagram</h1>
          <p className="text-xl text-gray-600 mb-8">
            We're redirecting you to our Instagram page where you can see safety infographics, community stories, and
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-6 py-3 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] text-white rounded-full hover:opacity-90 transition-opacity"
            >
